...
class ChampuAPI:
    ...
    def datagpt(args:str):
        ...
        try:
            ...
            return {"results":data["text"],"join": "@TheChampu", "success": True
                    }
    ...
    def blackbox(args: str) -> requests.Response:
        ...
        try:
            ...
            if response.status_code == 200:
                return {"results": response.text, "join": "@TheChampu", "success": True}
        except Exception as e:
            return e  
    ...
    def chatgpt(args:str,mode:str=False):
        ...
        if not mode:
            ...
            return {"results":response.json()["response"],"join": "@TheChampu", "success": True}
        else:
            try:
                result = gpt_4_mode(args, mode)
                return {"results":result,"join": "@TheChampu", "success": True}
    ...
    def randomword():
        ...
        return {"results": word, "join": "@TheChampu", "sucess": True}
    ...
    def gemini(args: str) -> dict:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return {"results":generated_text,"join": "@TheChampu", "success": True}
        except Exception as e:
            return e
    ...
    """
        ...
        if response.status_code == 200:
            ...
            return {"results": image_urls, "join": "@TheChampu", "success": True}
        else:
    ...
    """
        ...
        return {"results": result, "join": "@TheChampu", "sucess": True}
